...
My research interest includes **multimedia content security (e.g., steganalysis and steganography) and multimedia forensics (e.g. AI generated image and deepfake detection)**. I have published more than 15+ papers at the mainstream journal (e.g., IEEE TIFS et al.) and international conferences with total <a href='https://scholar.google.com/citations?user=JMhEzSgAAAAJ&hl=zh-CN'>google scholar citations <strong><span id='total_cit'>260+</span></strong>.  In addition, I am a member of the CSIG Special Committee on Digital Media Forensics and Security (CSIG-DMFS) and IEEE member. Also as a young editorial board member of Journal of Hainan University (Natural Science).
